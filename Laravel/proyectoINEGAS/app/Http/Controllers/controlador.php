        ...
        if(controladorUsuarios::existeUsuario($request->input('nombreUsuario'))){
            ...
            $request->input('contrasenhaUsuario'))){
                ...
                if($request->tipoPersona=='A'){
                    if(controladorUsuarios::usuarioEsDeTipo("tipoAlumno",$nombreP)>2){
                    ...
                    if(controladorUsuarios::usuarioEsDeTipo("tipoDocente",$nombreP)>2){
                    ...
                    if(controladorUsuarios::usuarioEsDeTipo("tipoTrabajador",$nombreP)>2){
